...
const Footer = () => {
  ...
  return (
    <div
      className="bg-gray-800 py-10 overflow-hidden" // Removed unnecessary overflow-y-hidden
      ...
      <div className="container mx-auto px-4 uk-card">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-around py-4">
          ...
          <div className="flex items-center justify-center mb-4 lg:mb-0">
            ...
            <img src={logo} alt="logo" className="h-20 w-40 rounded-md" />{" "}
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-10 ">
            ...
            {footerLinks.map((link, index) => (
              <div key={index} className="relative group  cursor-pointer text-slate-300 hover:text-blue-500 transition-all ">
                {link}
                {/* <span className="absolute left-0 bottom-0 w-0 h-[2px]  bg-blue-500 transition-all duration-300 ease-in-out "></span> */}
              </div>
            ))}
          </div>
        </div>
